...
;;; @(#) $Id: tinysearch.el 2138 2003-05-19 02:37:26Z blakem $
...
;; 22-Mar-1997|$Revision: 2138 $|~/misc/tinysearch.el.Z|
...
;; ~/.emacs startup file. Rip code with with tinylib.el/ti::m-pkg-rip-magic
;;
;;* _
;;* 	(require 'tinysearch)
;;* _
...
(ti::defgroup TinySword tinysearch-: extensions
...
`tinysearch-:word-boundary-set' eg. by looking at the file type."
  :type  'hook
  :group 'TinySearch)
  ...
  (let* ((type      (symbol-name major-mode))
    ...
    (cond
     ((string-match "^c-\\|^cc-\\|c[+]+" type)
      ...
      (setq space-word (save-excursion (or (ti::b-read-space-word) "")))
